                ...
                <div class="panel panel-success">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="livicon" data-name="bell" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> Edit Case {{ $case->case_number }}
                        </h3>
                    ...
                    <div class="panel-body">
                        <form id="caseForm" method="post" action="{{ route('cases.update', ['case' => $case->id]) }}">
                            @csrf
                            {{method_field('PUT')}}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="full_name" name="full_name" type="text" value="{{ $case->complainant->c_full_name }}" class="form-control required">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="age" name="age" type="text" value="{{ $case->complainant->c_age }}" class="form-control">
                                            @if ($errors->has('age'))
                                                <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="gender" id="gender">
                                                ...
                                                <option value="m"
                                                        @if($case->complainant->c_gender == "m")
                                                        selected
                                                        @endif
                                                ...
                                                <option value="f"
                                                        @if($case->complainant->c_gender == "f")
                                                        selected
                                                        @endif
                                                >FEMALE</option>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="occupation" name="occupation" type="text" value="{{ $case->complainant->c_occupation }}" class="form-control">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="phone_number" name="phone_number" type="text" value="{{ $case->c_address->ca_phone_number }}" class="form-control">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="email" name="email" type="text" value="{{ $case->c_address->ca_email }}" class="form-control">
                                            @if ($errors->has('email'))
                                                <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="home_address" name="home_address" type="text" value="{{ $case->c_address->ca_home_address }}" class="form-control ">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="incident_date" name="incident_date" type="text" value="{{ $case->incident->incident_date }}" class="form-control">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="incident_time" name="incident_time" type="text" value="{{ $case->incident->incident_time }}" data-format="hh:mm A" class="form-control">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="incident_location" name="incident_location" value="{{ $case->incident->incident_location }}" type="text" class="form-control">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="w_full_name" name="w_full_name" type="text" value="{{ $case->witness->w_full_name }}" class="form-control">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="w_phone_number" name="w_phone_number" type="text" value="{{ $case->witness->w_phone_number }}" class="form-control">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="incident_desc" class="summernote" name="incident_desc" cols="60" rows="10">{!! $case->incident->incident_desc !!}</textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="c_full_name" name="c_full_name" type="text" value="{{ $case->culprit->cu_full_name }}" class="form-control">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="c_age" name="c_age" type="text" value="{{ $case->culprit->cu_age }}" class="form-control">
                                            @if ($errors->has('c_age'))
                                                <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="c_occupation" name="c_occupation" type="text" value="{{ $case->culprit->cu_occupation }}" class="form-control">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="c_address" name="c_address" type="text" value="{{ $case->culprit->cu_address }}" class="form-control">
